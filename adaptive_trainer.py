...
model_name = f"aa_{OPTIMIZER}_{ES}_{AUGMENTATION}.pth"
...
for epoch in range(epochs):
    ...
    if Adaptive_Augmentation:
        if (epoch + 1) % update_interval == 0:
            ...
            new_aug_code = query_gpt_update(iou_history, accuracy_history, 
                                            f1_history, current_aug_str, prev_augs_str)
...
output_dir = f"aa_{OPTIMIZER}_{ES}_{AUGMENTATION}"
